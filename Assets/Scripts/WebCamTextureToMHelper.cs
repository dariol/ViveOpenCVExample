...
using UnityEngine.Events;
    ...
    public class WebCamTextureToMHelper : MonoBehaviour
    {
        /// <summary>
        /// Set this to specify the name of the device to use.
        /// </summary>
        public string requestedDeviceName = "HTC Vive";

        /// <summary>
        /// Set the requested width of the camera device.
        /// </summary>
        public int requestedWidth = 612;

        /// <summary>
        /// Set the requested height of the camera device.
        /// </summary>
        public int requestedHeight = 460;
		...
		Debug.Log("starting play: " + webCamTexture.deviceName);
            // Starts the camera
            webCamTexture.Play ();
